...
class Metasploit3 < Msf::Exploit::Remote
	...
	def initialize(info = {})
		super(update_info(info,
			'Name'           => 'Portable SDK for UPnP Devices (libupnp) RCE',
			'Description'    => %q{
			...
			'Author'         => [
					'Trae Horton <sorsnce[at]protonmail.com>'	    # Exploit dev for Sorsnce Enterprise Security
				],
			'License'        => MSF_LICENSE,
			'References'     =>
				[
					[ 'CVE', '2012-5959' ],
					[ 'US-CERT-VU', '922681' ],
					[ 'URL', 'https://www.sorsnce.com/2017/05/15/using-windows-fsrm-to-build-a-killswitch-for-ransomware/' ]
				],
			'Platform'       => ['unix'],
			'Arch'           => ARCH_CMD,
			'Privileged'     => true,
...
#						"\x22",
			...
			'Targets'        =>
				[
					...
					#
					[ "Supermicro Onboard IPMI (X9SCL/X9SCM) Portable SDK 1.4.6", {
						...
						:fingerprint =>
							/Server:\s*Linux\/2\.6\.24\-rt1-hi3515v100\, UPnP\/1\.0, Portable SDK for UPnP devices\/1\.4\.6/
